...
class _LoginPageState extends State<LoginPage>
          ...
          child: ValueListenableBuilder(
            ...
            builder: (context, state, _) => Column(
              children: [
                ...
                if (state case LoginPageLoaded(:final user)) Text(user.token),
                if (state case LoginPageFailure(:final message)) Text(message),
                Padding(
  ...
  Future<void> _login() async {
    ...
    await notifier.login(identity: _email.text, password: _password.text);
  }
}
